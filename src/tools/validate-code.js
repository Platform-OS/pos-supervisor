...
export const validateCodeTool = {
  ...
  description: [
    'PURPOSE:',
    'Validate platformOS code content prior to any write operation. Returns enriched diagnostics,',
    'fix hints, LSP intelligence, domain guidance, and structural analysis.',
    '',
    'MANDATE (NON-NEGOTIABLE):',
    'Call this tool BEFORE writing any new *.liquid|*.graphql|*.yml file to disk AND before applying any modification to an existing file.',
    'SKIPPING THIS STEP = FAIL.',
    '',
    'REQUIRED PROCEDURE:',
    ...
    '',
    'CONSTRAINTS:',
    '  - NEVER call validate_code with partial content.',
